...
export default function Poetry() {
  ...
  const getImageUrl = (imageName: string | null) => {
    if (!imageName || !supabase) return null
      ...
      <div className="relative">
        ...
        <div className="fixed inset-0 -z-30">
          ...
          <div
            ...
            style={{
              backgroundImage: `url('/assets/poetry-bg.jpg')`,
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="relative z-10 text-center mb-12">
            ...
            <div className="mt-6 flex items-center justify-center gap-2">
              <div className="w-20 h-0.5 bg-gradient-to-r from-transparent via-gold to-purple-500 rounded-full" />
              <span className="font-inter text-sm text-gray-500">Explore</span>
              <div className="w-20 h-0.5 bg-gradient-to-r from-purple-500 via-gold to-transparent rounded-full" />
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8 justify-items-center">
              {poems.map((poem) => {
                ...
                return (
                  <div
                    key={poem.id}
                    className="w-full max-w-[280px] h-[340px] relative rounded-2xl overflow-hidden group cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-2xl glass-card"
                  ...
                  >
                    ...
                    <div className="w-full h-full p-2 flex justify-between relative z-10">
                      <div className="w-3/5 p-2 pt-3 pb-1.5 flex flex-col rounded-xl glass-panel text-white font-medium font-mono shadow-lg">
                        <span
                          className="text-xl font-medium truncate drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]"
                          title={poem.title}
                        >
                          {poem.title}
                        </span>
                        ...
                        <div className="w-full mt-auto flex items-center justify-center">
                          <span className="text-xs text-gray-200 drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
                      ...
                      <div className="h-full pt-2 flex flex-col items-end text-white">
                        <span className="text-[10px] leading-[12px] drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
                          Poetry
                        </span>
                        <span className="text-[10px] leading-[13px] drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
                          by Vinee
                        </span>
                        <div className="w-8 h-8 mt-auto flex items-center justify-center rounded-full glass-button shadow-lg">
        ...
        {selectedPoem && (
          <div
            className="fixed inset-0 glass-modal flex items-center justify-center z-50 p-6"
            onClick={() => setSelectedPoem(null)}
          >
            <div
              className="glass-card max-w-3xl w-full max-h-[90vh] overflow-auto p-8 relative rounded-2xl"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Close button */}
              <button
                className="absolute top-4 right-4 w-10 h-10 rounded-full glass-button flex items-center justify-center text-white z-10"
                onClick={() => setSelectedPoem(null)}
              >
