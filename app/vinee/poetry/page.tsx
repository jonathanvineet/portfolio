      ...
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-12">
          ...
          <div className="mt-6 flex items-center justify-center gap-2">
            <div className="w-20 h-0.5 bg-gradient-to-r from-transparent via-gold to-purple-500 rounded-full"></div>
            <span className="font-inter text-sm text-gray-500">Explore</span>
            <div className="w-20 h-0.5 bg-gradient-to-r from-purple-500 via-gold to-transparent rounded-full"></div>
          </div>
        </div>
